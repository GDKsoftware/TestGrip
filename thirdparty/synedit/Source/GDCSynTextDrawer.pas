...
begin
  Result := GDCSynUnicode.TextExtent(FStockBitmap.Canvas, Text);
end;

function TheTextDrawer.TextExtent(Text: PWideChar; Count: Integer): TSize;
begin
  Result := GDCSynUnicode.GetTextSize(FStockBitmap.Canvas.Handle, Text, Count);
end;

function TheTextDrawer.TextWidth(const Text: UnicodeString): Integer;
begin
  Result := GDCSynUnicode.TextExtent(FStockBitmap.Canvas, Text).cX;
end;

function TheTextDrawer.TextWidth(Text: PWideChar; Count: Integer): Integer;
begin
  Result := GDCSynUnicode.GetTextSize(FStockBitmap.Canvas.Handle, Text, Count).cX;
end;
