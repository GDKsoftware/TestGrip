...
{$IFNDEF SYN_CLX}
type
  TBetterRegistry = GDCSynEditMiscClasses.TBetterRegistry;
{$ENDIF}
...
begin
  if FExportName = '' then
    FExportName := GDCSynEditMiscProcs.DeleteTypePrefixAndSynSuffix(ClassName);
  Result := FExportName;
end;
