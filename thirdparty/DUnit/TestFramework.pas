{#(@)$Id: TestFramework.pas 23 2008-08-26 04:42:20Z judc $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas 23 2008-08-26 04:42:20Z judc $';
  rcs_version : string = '$Revision: 23 $';
...
{$IFDEF madExcept}
  ...
  {$ELSE}
  (* v4
  StackTrace(bool hideUglyItems = false, bool showRelativeAddrs = false, bool showRelativeLines = false, TPStackTrace stackTrace = NULL, Windows::PContext context = NULL, void * currentAddr = NULL, bool isException = false, bool extException = false, unsigned stackBottom = (unsigned)(0x0), unsigned stackTop = (unsigned)(0x0), void * creator = NULL, Madtypes::TPPointer exceptAddr = NULL, Madtypes::TPPointer exceptFunc = NULL, Madtypes::TPPointer exceptFuncAddr = NULL, Madnvprgralert::_di_IProgressAlert progressAlert = Madnvprgralert::_di_IProgressAlert(), unsigned ebp = (unsigned)(0x0), bool dumbTrace = false, bool bcbTermination = false, System::AnsiString preparedStack = "", Madtypes::TPBoolean pAbort = NULL, Madtypes::TPCardinal pCrc1 = NULL, Madtypes::TPCardinal pCrc2 = NULL, Madtypes::TPBoolean pDelphiThread = NULL, Madtypes::TPDAUnicodeString pMinDebugInfos = NULL, bool dontAddTopItem = false);
  *)
